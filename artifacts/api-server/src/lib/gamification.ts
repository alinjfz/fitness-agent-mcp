...
export const ACHIEVEMENT_DEFS = [
  { id: "first_workout", name: "First Rep", description: "Logged your first workout", xpBonus: 100, icon: "💪" },
  { id: "first_diet", name: "Clean Plate", description: "Logged your first diet session", xpBonus: 50, icon: "🥗" },
  { id: "streak_3", name: "On A Roll", description: "Maintained a 3-day streak", xpBonus: 75, icon: "🔥" },
  { id: "streak_7", name: "Week Warrior", description: "Maintained a 7-day streak", xpBonus: 200, icon: "⚡" },
  { id: "streak_14", name: "Fortnight Fighter", description: "Maintained a 14-day streak", xpBonus: 400, icon: "🏅" },
  { id: "streak_30", name: "Iron Habit", description: "Maintained a 30-day streak", xpBonus: 1000, icon: "💎" },
  { id: "level_5", name: "Getting Serious", description: "Reached Level 5", xpBonus: 150, icon: "⭐" },
  { id: "level_10", name: "Dedicated", description: "Reached Level 10", xpBonus: 300, icon: "🌟" },
  { id: "level_25", name: "Elite", description: "Reached Level 25", xpBonus: 750, icon: "🏆" },
  { id: "logs_10", name: "Consistent", description: "Logged 10 completions", xpBonus: 100, icon: "📈" },
  { id: "logs_25", name: "Quarter Century", description: "Logged 25 completions", xpBonus: 175, icon: "🎯" },
  { id: "logs_50", name: "Committed", description: "Logged 50 completions", xpBonus: 250, icon: "🔑" },
  { id: "logs_100", name: "Century Club", description: "Logged 100 completions", xpBonus: 500, icon: "🎖️" },
  { id: "workouts_10", name: "Iron Will", description: "Completed 10 workouts", xpBonus: 125, icon: "🏋️" },
  { id: "workouts_25", name: "Sweat Equity", description: "Completed 25 workouts", xpBonus: 200, icon: "💦" },
  { id: "workouts_50", name: "Machine", description: "Completed 50 workouts", xpBonus: 400, icon: "🤖" },
  { id: "diet_10", name: "Nutrition Novice", description: "Logged 10 diet sessions", xpBonus: 100, icon: "🥑" },
  { id: "diet_25", name: "Fueled Right", description: "Logged 25 diet sessions", xpBonus: 175, icon: "🍎" },
];
...
export function computeNewStreak(
  ...
  if (diffHours < 20) return existingStreak;
  // Consecutive day window (20h–48h) — increment
  if (diffHours < 48) return existingStreak + 1;
  // Within 4-day grace period (48h–96h) — still increment (didn't miss 4 days yet)
  if (diffHours < 96) return existingStreak + 1;
  // More than 4 days with no log — streak resets
  return 1;
}
...
export function checkNewAchievements(
  ...
  const candidates: Array<{ id: string; condition: boolean }> = [
    ...
    { id: "logs_25", condition: totalLogs >= 25 },
    { id: "logs_50", condition: totalLogs >= 50 },
    { id: "logs_100", condition: totalLogs >= 100 },
    { id: "workouts_10", condition: workoutCount >= 10 },
    { id: "workouts_25", condition: workoutCount >= 25 },
    { id: "workouts_50", condition: workoutCount >= 50 },
    { id: "diet_10", condition: dietCount >= 10 },
    { id: "diet_25", condition: dietCount >= 25 },
  ];
